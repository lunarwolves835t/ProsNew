...
void deploy() {
  int trayDistance = 3080; //2800 2900 3080
  int pushDistance = 15; // 400 500
  int outtakeDistance = 500;
  int trayBack = 3150;

  int traySpeed = 80; // was 80
  int intakeSpeed = 70;
  int driveSpeed = 50;
...
void deployNine() {
  int trayDistance = 3060; //2800 2900 // 3080
  int trayDistanceTwo = 1500;
  int pushDistance = 15; // 400 500
  int outtakeDistance = 500;
  int trayBack = 3150;
...
// brings tray out
  ...
  if (!kill) {
    ...
    while (tray.get_position() > -trayDistanceTwo) {
      killSwitch();
      if (!kill) {
        tray.move(-traySpeed);
        //std::string thing = std::to_string(tray.get_position());
